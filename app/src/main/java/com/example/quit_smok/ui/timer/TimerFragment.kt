...
class TimerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Отложить вызов до полной загрузки фрагмента
        return root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        // Запускаем таймер только после создания view
        updateTimerDisplay()
        startTimerUpdate()
    }
    ...
    private fun showOutsideAwakeDialog() {
        AlertDialog.Builder(context)
            ...
            .show()
        // TODO: Настройте цвета кнопок (красная "Курить", зелёная "Отмена")
    }
    ...
    private fun showEarlySmokeDialog(remainingMillis: Long) {
        ...
        AlertDialog.Builder(context)
            ...
            .show()
        // TODO: Настройте цвета кнопок (красная "Курить", зелёная "Подождать")
    }
